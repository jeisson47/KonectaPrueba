        ...
        <table class="table my-5">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="d-flex"><a href="{{route('products.edit',$producto->id)}}" class="btn btn-primary mx-3">Editar</a>
                        <form action="{{route('products.destroy',$producto->id)}}" method="POST">@csrf @method('DELETE') <button type="submit"
