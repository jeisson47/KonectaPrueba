        ...
        <div class="row">
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="nameInput" value="{{$producto->name}}" name="name" placeholder="Nombre" required>
            ...
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="referenceInput" name="reference" value="{{$producto->reference}}" placeholder="Refencia Ej RC-2022-GDEYHGFYUEY" required>
            ...
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="valueInput" name="value" placeholder="Valor" value="{{$producto->value}}" required>
            ...
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="weightInput" name="weight" placeholder="Peso" value="{{$producto->weight}}" required>
            ...
            <div class="col-6">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="stockInput" name="stock" value="{{$producto->stock}}" placeholder="Cantidad de productos" required>
